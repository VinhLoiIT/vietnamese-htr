...
class CERTestCase(unittest.TestCase):
    ...
    def test_cer_3(self):
        ...
        self.assertEqual(self.cer.compute(), 2/3)
        self.cer.update((['a'], ['a']))
        self.assertEqual(self.cer.compute(), ((2+0)/(3+1)))
        self.cer.update((['de'], ['fgh']))
        self.assertEqual(self.cer.compute(), ((2+0+3)/(3+1+3)))
...
class RunningCERTestCase(unittest.TestCase):
    ...
    def test_running_cer_0(self):
        ...
        self.assertEqual(state.metrics['CER'], ((0+1+1)/(3+1+3)))
...
class WERWordTestCase(unittest.TestCase):
    ...
    def test_wer_3(self):
        ...
        self.wer.update((['a'], ['a']))
        self.assertEqual(self.wer.compute(), ((1+0)/(1+1)))
        self.wer.update((['de'], ['fgh']))
        self.assertEqual(self.wer.compute(), ((1+0+1)/(1+1+1)))
...
class RunningWERTestCase(unittest.TestCase):
    ...
    def test_running_wer_0(self):
        ...
        self.assertEqual(state.metrics['WER'], ((2+0+1)/(3+3+1)))
    ...
    def test_running_wer_3(self):
        ...
        self.assertEqual(state.metrics['WER'], ((0+1+1)/(1+1+1)))
...
class NormalizedCERTestCase(unittest.TestCase):
    def setUp(self):
        self.cer = CharacterErrorRate(is_global_ed=False)
...
class RunningNormalizedCERTestCase(unittest.TestCase):
    def setUp(self):
        self.dummy_engine = Engine(self.dummy_output)
        Running(CharacterErrorRate(is_global_ed=False)).attach(self.dummy_engine, 'CER')
...
class NormalizedWERWordTestCase(unittest.TestCase):
    def setUp(self):
        self.wer = WordErrorRate(is_global_ed=False)
...
class RunningNormalizedWERTestCase(unittest.TestCase):
    def setUp(self):
        self.dummy_engine = Engine(self.dummy_output)
        Running(WordErrorRate(is_global_ed=False)).attach(self.dummy_engine, 'WER')
