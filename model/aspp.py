# Ref https://github.com/fregu856/deeplabv3/blob/master/model/aspp.py
...
class ASPP(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        # self.conv_1x1_2 = nn.Conv2d(512, out_channels, kernel_size=1)
        # self.bn_conv_1x1_2 = nn.BatchNorm2d(out_channels)

        # self.conv_1x1_3 = nn.Conv2d(1280, out_channels, kernel_size=1) # (1280 = 5*out_channels)
        self.conv_1x1_3 = nn.Conv2d(4*out_channels, out_channels, kernel_size=1) # (1024 = 4*out_channels)
