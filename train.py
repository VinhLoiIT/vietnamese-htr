...
def main(args):
    ...
    if args.debug_model:
        ...
        dummy_output_train = model(dummy_image_input, dummy_target_input.transpose(0,1))
        dummy_output_greedy, _ = model.greedy(dummy_image_input, dummy_target_input[[0]].transpose(0,1))
